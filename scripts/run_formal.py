...
def main() -> int:
    ...
    # Deliberately free of wall-clock times and worker counts: this file is
    # regenerated by the formal workflow and diffed against the committed copy,
    # so it has to be identical on every machine. Timings live in summary.json.
    lines = [
        ...
        "",
        f"{passed} of {len(results)} proofs pass. Solver times are in "
        f"summary.json alongside this file.",
        "",
